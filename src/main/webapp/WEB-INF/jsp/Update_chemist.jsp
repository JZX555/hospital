...
<body class="gray-bg">
                                   ...
                                   <div class="form-group">
                                        <label>可更新状态为：</label>
		                                    <select class="form-control m-b" name="pstate" id="pstate">
		                                        <option value="5">正在发药</option>
		                                        <option value="6">发药结束</option>
		                                        <option value="1">申请退药</option>
		                                    </select>
                                    </div>
                                    <div>
    ...
    <script>
	    ...
	    function getPreById(id){
	    	...
	    	$.ajax({
        		url: '/Chemist/getPrecriptionByID',
        		type: 'POST',
        		data: {'ID':id},
        		dataType: 'JSON',
        ...
        function updatestate(){
			...
			var preid=$('#preid').val();
        	$.ajax({
        		url: '/Chemist/updatePrescriptionByID',
        		type: 'POST',
        		data: {'ID':preid,
        			'state':pstate
        			},
        		...
        		success: function(result){
        			...
        			if(result>0){
        				layer.alert('更新成功',function(index){
        					...
        					//alert(111);
        					//window.location.href="/Chemist/show_dispenser";
        				});
